...
# ID Prodi D3 Sistem Informasi (sesuai sistem)
NAMA_PRODI = "DIII SISTEM INFORMASI"
...
def api_mahasiswa_d3():
    ...
    API_KEY = "X-UPNVJ-API-KEY"
    API_SECRET = "Cspwwxq5SyTOMkq8XYcwZ1PMpYrYCwrv"
    ID_PRODI_SISFO = 6  # berdasarkan contoh respons JSON
...
def detail_mahasiswa(nim):
    try:
        ...
        return render_template("detail_nilai_d3.html", mahasiswa={
